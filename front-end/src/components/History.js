...
const History = () => {
  ...
  const handleStatusChange = async (chequeId, newStatus) => {
    ...
    try {
      ...
      // API call to update status using the endpoint from app.py
      await axios.put(
  ...
  const handleSaveEdit = async (chequeId) => {
    ...
    try {
      ...
      // API call to update cheque using PUT endpoint from app.py
      await axios.put(
  ...
  const handleDelete = async (chequeId) => {
    ...
    try {
      ...
      // API call to delete cheque using DELETE endpoint from app.py
